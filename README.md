...
```bash
# macOS (Apple Silicon)
curl -L https://github.com/Anvil-Cloud-AI/anvil-scanner/releases/latest/download/anvil-scanner_latest_darwin_arm64.tar.gz | tar xz
sudo mv anvil-scanner /usr/local/bin/

# macOS (Intel)
curl -L https://github.com/Anvil-Cloud-AI/anvil-scanner/releases/latest/download/anvil-scanner_latest_darwin_amd64.tar.gz | tar xz
sudo mv anvil-scanner /usr/local/bin/

# Linux (amd64)
curl -L https://github.com/Anvil-Cloud-AI/anvil-scanner/releases/latest/download/anvil-scanner_latest_linux_amd64.tar.gz | tar xz
sudo mv anvil-scanner /usr/local/bin/

# Linux (arm64 / Raspberry Pi)
curl -L https://github.com/Anvil-Cloud-AI/anvil-scanner/releases/latest/download/anvil-scanner_latest_linux_arm64.tar.gz | tar xz
sudo mv anvil-scanner /usr/local/bin/
```
